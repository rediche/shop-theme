<div class="search">
  <form method="get" role="search" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="search__form">
    ...
    <input class="input search__input search__input--has-results" value="<?php echo get_search_query(); ?>" placeholder="Søg" name="s" data-search-input>
    <input type="hidden" name="post_type" value="product" />
    <div class="search__results list card" data-search-results></div>
  </form>
</div>